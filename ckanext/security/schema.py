...
from ckanext.security.validators import (
    user_password_validator, old_username_validator, ensure_str, user_name_sanitize, user_fullname_sanitize
)
...
def default_user_schema():
    schema = {
        ...
        'about': [ignore_missing, ensure_str, user_about_validator],
        'created': [ignore],
